    ...
    $(function() {
        ...
        if ($('.ct-chart-polar').length) {
            new Chartist.Line('.ct-chart-polar', {
                labels: [1, 2, 3, 4, 5, 6, 7, 8],
                series: [
                    [Math.random()*4, Math.random()*3, Math.random()*-2, Math.random()*3, Math.random()*-4, Math.random()*6, Math.random()*2, Math.random()*1],
                    [Math.random()*3, Math.random()*3, Math.random()*2, Math.random()*3, Math.random()*4, Math.random()*6, Math.random()*2, Math.random()*1],
                    [Math.random()*6, Math.random()*1, Math.random()*-5, Math.random()*-4, Math.random()*-4, Math.random()*2, Math.random()*1, Math.random()*1],
                ]
            }, {
                high: 3,
                low: -3,
